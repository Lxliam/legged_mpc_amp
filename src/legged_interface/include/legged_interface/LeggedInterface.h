...
class LeggedInterface : public RobotInterface {
 public:
  ...
  bool hasSelfCollision() const { return selfCollisionEnabled_ && geometryInterfacePtr_ != nullptr; }
 ...
 protected:
  ...
  std::unique_ptr<StateInputCost> getFootTrajectoryTrackingCost(const EndEffectorKinematics<scalar_t>& eeKinematics,
                                                                size_t footIndex, const std::string& taskFile, bool verbose);
  ...
  bool selfCollisionEnabled_{true};
